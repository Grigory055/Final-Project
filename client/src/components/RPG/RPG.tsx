...
export function RPG() {
  ...
  const rod1 = new Rod(
    gridCells(39),
    gridCells(20),
    <QuestionsP0W1 handleCloseClick={handleCloseClick} />
  );
  ...
  const rod2 = new Rod(
    gridCells(46),
    gridCells(39),
    <QuestionsP0W2 handleCloseClick={handleCloseClick} />
  );
  ...
  const rod3 = new Rod(
    gridCells(35),
    gridCells(48),
    <QuestionsP0W3 handleCloseClick={handleCloseClick} />
  );
  ...
  const sveta = new NPC(
    gridCells(24),
    gridCells(26),
    <DialogSvetaPhase0 handleCloseClick={handleCloseClick} />,
    384,
    384,
    0
  );
  ...
  useEffect(() => {
    ...
    hero.position = new Vector2(gridCells(26), gridCells(56));
